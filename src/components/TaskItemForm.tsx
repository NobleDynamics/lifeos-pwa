...
export function TaskItemForm({ editingItem: editingItemProp, onClose, accentColor = '#00EAFF' }: TaskItemFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-lg bg-dark-100 rounded-t-2xl shadow-xl animate-slide-up max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-dark-300 sticky top-0 bg-dark-100">
